...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const emailResponse = await resend.emails.send({
      ...
      to: [email],
      subject: `Lamentamos verte partir 💔 | Raw Paw`,
      html: `
        <!DOCTYPE html>
        <html lang="es">
        <head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 8px 30px rgba(63, 52, 43, 0.08);">
                  ...
                  <tr>
                    <td style="padding: 48px 40px 32px 40px;">
                      ...
                      <p style="color: #4a5568; font-size: 16px; line-height: 1.7; margin: 0 0 16px 0;">
                        Confirmamos que tu suscripción de <strong style="color: #677755;">Raw Paw</strong> para <strong>${displayPet}</strong> ha sido cancelada exitosamente.
                      </p>

                      <p style="color: #4a5568; font-size: 16px; line-height: 1.7; margin: 0 0 24px 0;">
                        Fue un placer alimentar a ${displayPet} con la mejor nutrición natural. 
                        Si en algún momento decides regresar, aquí estaremos con los brazos (y patas) abiertos. 🐾
                      </p>
                      
                      <div style="background-color: #f4f6f0; border-radius: 16px; padding: 24px; margin: 28px 0; border-left: 4px solid #CAD8A3;">
                        <p style="color: #3F342B; font-size: 15px; line-height: 1.6; margin: 0; font-weight: 600;">
                          ¿Cambiaste de opinión? 🤔
                        </p>
                        <p style="color: #4a5568; font-size: 14px; line-height: 1.6; margin: 8px 0 0 0;">
                          Puedes reactivar tu plan en cualquier momento. Solo escríbenos por WhatsApp y te ayudamos.
                        </p>
                      </div>
                      
                      <div style="text-align: center; margin: 36px 0;">
                        <a href="https://wa.me/522213606464?text=Hola%20Raw%20Paw%2C%20me%20gustaría%20reactivar%20mi%20suscripción" 
                      ...
                      <p style="color: #a0aec0; font-size: 13px; line-height: 1.6; margin: 24px 0 0 0;">
                        Gracias por haber sido parte de la familia Raw Paw. 
                        ${displayPet} siempre será parte de nuestra manada. 🐕
                      </p>
                    </td>
                  </tr>
