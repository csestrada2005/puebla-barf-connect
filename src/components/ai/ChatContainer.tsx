    ...
    <div className="flex flex-col h-[calc(100vh-80px)] max-h-[calc(100dvh-80px)] relative">
      ...
      <div className="flex-shrink-0 relative">
        ...
        <motion.img
          ...
          className="absolute left-0 bottom-full z-10 pointer-events-none md:hidden w-28 object-contain drop-shadow-lg -mb-9.3"
        />
        ...
        <motion.img
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.4, ease: "easeOut" }}
          className="absolute -right-4 bottom-full z-10 pointer-events-none md:hidden w-32 object-contain drop-shadow-lg -mb-9.5"
        />
