          ...
          <div className="hidden lg:block w-72 flex-shrink-0 relative">
            <div className="sticky top-24">
              <img 
                ...
                className="w-60 xl:w-72 object-contain drop-shadow-xl pointer-events-none"
              />
            </div>
          </div>

          {/* Main Content Column */}
          <div className="flex-1 max-w-3xl mx-auto lg:mx-0 lg:ml-8">
            <div className="text-center lg:text-left mb-12">
              <Book className="h-12 w-12 mx-auto lg:mx-0 mb-4 text-primary" />
